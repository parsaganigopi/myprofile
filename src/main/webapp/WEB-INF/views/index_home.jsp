                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="${contextPath}/index">GOPI NADH</a>
                            <i class="brand_network"><small><small>GProfile</small></small></i>
                        </div>
...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:700px">
	    <p style="text-align:justify;">DevOps (development and operations) is an enterprise software development phrase used to mean a type of agile relationship between development and IT operations. The goal of DevOps is to change and improve the relationship by advocating better communication and collaboration between these two business units.
	    </p>
	    <p><strong>Address:</strong> Hyderabad-16</p> 
	    <p><strong>Ph No: </strong>  +91-79xxxxxxxx</p>
		<p><strong>E-Mail ID :</strong>  gopinadh243p@gmail.com</p>
  	</div>
   </div>
...
<footer class="w3-center  w3-padding-16" style="background-color:#1C3B47 ">
  <p style="color:#FFFFFF ">Copyright @2017 <a href="#"  target="_blank" class="w3-hover-text-green"> gopinadhit.com</a></p>
</footer>
